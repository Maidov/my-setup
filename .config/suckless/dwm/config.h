...
static const char *dmenucmd[] = { "dmenu_run", "-i", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg_inact, "-nf", col_fg_inact, "-sb", col_border_act, "-sf", col_bg_inact, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *termcmdfloat[]  = { "stf", NULL };

static const Key keys[] = {
	/* modifier            key        function        argument */
	{ MODKEY,               33,     spawn,          {.v = dmenucmd } }, // p
	{ MODKEY|ShiftMask,     36,     spawn,          {.v = termcmd } }, // Return
	{ MODKEY|ShiftMask|ControlMask,     36,     spawn,          {.v = termcmdfloat } },
